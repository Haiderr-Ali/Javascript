const score =400 
const balance = new Number(100) //explicitely convert into number
console.log(balance);

console.log(balance.toString().length); // it shows the length of string
...
// +++++++++++++++++++Maths++++++++++++++++++++//
console.log(Math.abs(-4)); //change negative topositive
